...
st.title("Stock Market Prediction Dashboard")  # Removed Unicode emojis to avoid the error
...
if data is not None:
    ...
    fig.add_trace(go.Scatter(x=data.index, y=data["MA100"], mode="lines", name="MA100", line=dict(color="blue")))
    fig.add_trace(go.Scatter(x=data.index, y=data["MA200"], mode="lines", name="MA200", line=dict(color="orange")))

    fig.update_layout(title="Price and Moving Averages", xaxis_title="Date", yaxis_title="Price", template="plotly_dark")
